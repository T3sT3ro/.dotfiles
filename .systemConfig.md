...
- [ ] convert "system config" to changelog.md or something - remember a changelog involves both changes to files tracked by git and local, non tracked changes like instaleld packages (future chore: migrate to NIX/OS for declarative system configuration)
- [ ] switch over to zsh
...
- [ ] wezterm
    - [x] use it by default
    - [ ] go through shortcuts, learn them and improve
