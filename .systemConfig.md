...
- rendering with GPU offload support:  
  ```
...
- installed `ffmpegthumbnailer` and `gstreamer1.0-libav`, disabled totem thumbnailer inside `/usr/share/thumbnailers/totem.thumbnailer`
- installed firefox deb from mozilla PPA
